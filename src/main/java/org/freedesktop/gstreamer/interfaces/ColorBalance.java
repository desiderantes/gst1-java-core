...
public class ColorBalance extends GstInterface {
    ...
    /**
     * Wraps the {@link Element} in a <pre>ColorBalance</pre> interface
     *
     * @param element the element to use as a <pre>ColorBalance</pre>
     * @return a <pre>ColorBalance</pre> for the element
     */
