...
public class VideoOverlay extends GstInterface {
    /**
     * Creates a new <pre>VideoOverlay</pre> instance
     *
    ...
    /**
     * Wraps the {@link Element} in a <pre>XOverlay</pre> interface
     *
     * @param element the element to use as a <pre>XOverlay</pre>
     * @return a <pre>XOverlay</pre> for the element
     */
