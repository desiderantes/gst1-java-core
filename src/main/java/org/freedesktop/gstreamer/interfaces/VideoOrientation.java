...
public class VideoOrientation extends GstInterface {
    ...
    /**
     * Wraps the {@link Element} in a <pre>VideoOrientation</pre> interface
     *
     * @param element the element to use as a <pre>VideoOrientation</pre>
     * @return a <pre>VideoOrientation</pre> for the element
     */
