...
public class Navigation extends GstInterface {
     ...
     *
     * @param element the element that implements the Navigation interface
     */
    ...
    /**
     * Wraps the {@link Element} in a <pre>Navigation</pre> interface
     *
     * @param element the element to use as a <pre>Navigation</pre>
     * @return a <pre>Navigation</pre> for the element
     */
