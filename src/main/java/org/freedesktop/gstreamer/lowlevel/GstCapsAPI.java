...
public interface GstCapsAPI extends com.sun.jna.Library {
    ...
    @CallerOwnsReturn
    Pointer ptr_gst_caps_new_simple(String media_type, String fieldName, Object... args);

    @CallerOwnsReturn
    Pointer ptr_gst_caps_new_full(Structure... data);
    ...
    @CallerOwnsReturn
    Caps gst_caps_new_simple(String media_type, String fieldName, Object... args);

    @CallerOwnsReturn
    Caps gst_caps_new_full(Structure... data);

    @CallerOwnsReturn
    Pointer ptr_gst_caps_copy(Caps caps);

    @CallerOwnsReturn
    Pointer ptr_gst_caps_from_string(String string);
    ...
    @CallerOwnsReturn
    Caps gst_caps_merge(@Invalidate Caps caps1, @Invalidate Caps caps2);
    ...
    @CallerOwnsReturn
    Structure gst_caps_steal_structure(Caps caps, int index);

    @CallerOwnsReturn
    Caps gst_caps_copy_nth(Caps caps, int nth);

    @CallerOwnsReturn
    Caps gst_caps_truncate(Caps caps);
    ...
    @CallerOwnsReturn
    Caps gst_caps_simplify(Caps caps);
