...
public interface GstClockAPI extends com.sun.jna.Library {
    ...
    @CallerOwnsReturn
    ClockID gst_clock_new_single_shot_id(Clock clock, long time);

    @CallerOwnsReturn
    ClockID gst_clock_new_periodic_id(Clock clock, long start_time, long interval);
