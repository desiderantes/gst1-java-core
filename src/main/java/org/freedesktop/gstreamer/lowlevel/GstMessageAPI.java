...
public interface GstMessageAPI extends com.sun.jna.Library {
    ...
    @CallerOwnsReturn
    GstMessagePtr gst_message_new_eos(GstObjectPtr src);
    ...
    @CallerOwnsReturn
    Message gst_message_new_duration_changed(GstObject src);
    ...
    @CallerOwnsReturn
    Message gst_message_new_need_context(GstObject source, String context_type);

    @FieldOrder({"mini_object", "type", "timestamp", "src",
            "seqnum", "lock", "cond"})
    final class MessageStruct extends com.sun.jna.Structure {
