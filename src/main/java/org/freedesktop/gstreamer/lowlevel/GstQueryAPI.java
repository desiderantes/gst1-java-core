...
public interface GstQueryAPI extends com.sun.jna.Library {
    ...
    /* convert query */
    @CallerOwnsReturn
    Query gst_query_new_convert(Format src_format, /* gint64 */ long value, Format dest_format);
    ...
    /* allocation query */
    @CallerOwnsReturn
    Query gst_query_new_allocation(Caps caps, boolean need_pool);
    ...
    interface GstQueryTypeFlags {
        int UPSTREAM = 1;
        int DOWNSTREAM = 1 << 1;
        int SERIALIZED = 1 << 2;
        int BOTH = UPSTREAM | DOWNSTREAM;
    }

    final class QueryStruct extends com.sun.jna.Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("mini_object", "type");
        }
    }
}
