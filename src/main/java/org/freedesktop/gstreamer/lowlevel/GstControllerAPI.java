...
public interface GstControllerAPI extends Library {
    ...
    @CallerOwnsReturn
    GstDirectControlBindingPtr gst_direct_control_binding_new(
            GstObjectPtr object,
            String property_name,
            GstControlSourcePtr cs);

    @CallerOwnsReturn
    GstDirectControlBindingPtr gst_direct_control_binding_new_absolute(
            GstObjectPtr object,
            String property_name,
            GstControlSourcePtr cs);

    @CallerOwnsReturn
    GstARGBControlBindingPtr gst_argb_control_binding_new(
            GstObjectPtr object,
            String property_name,
    ...
    // since 1.12
    @CallerOwnsReturn
    GstProxyControlBindingPtr gst_proxy_control_binding_new(
            GstObjectPtr object,
            String property_name,
    ...
    @CallerOwnsReturn
    GlibAPI.GList gst_timed_value_control_source_get_all(
            GstTimedValueControlSourcePtr self);
