...
public interface GValueAPI extends Library {
    ...
    @CallerOwnsReturn
    String g_strdup_value_contents(GValue value);
    ...
    interface NoMapperAPI extends Library {
    ...
    final class GValue extends com.sun.jna.Structure {
        ...
        private <T> T validateVal(Object val, Class<T> clazz, boolean allowNull) {
            ...
            if (!clazz.isInstance(val)) {
                throw new IllegalArgumentException("Argument is of wrong type for GType." + g_type);
            }
...
//            } else if (g_type.equals(GType.OBJECT)) { return toObject();
            } else if (g_type.equals(GType.POINTER)) {
                return toPointer();
...
//            return GVALUE_API.g_value_get_object(this);
        ...
        public void setValue(Object val) {
            ...
            if (g_type.equals(GType.INT)) {
                GVALUE_API.g_value_set_int(this, validateVal(val, Integer.class));
            } else if (g_type.equals(GType.UINT)) {
                GVALUE_API.g_value_set_uint(this, validateVal(val, Integer.class));
            } else if (g_type.equals(GType.CHAR)) {
                GVALUE_API.g_value_set_char(this, validateVal(val, Byte.class));
            } else if (g_type.equals(GType.UCHAR)) {
                GVALUE_API.g_value_set_uchar(this, validateVal(val, Byte.class));
            } else if (g_type.equals(GType.LONG)) {
                GVALUE_API.g_value_set_long(this, validateVal(val, NativeLong.class));
            } else if (g_type.equals(GType.ULONG)) {
                GVALUE_API.g_value_set_ulong(this, validateVal(val, NativeLong.class));
            } else if (g_type.equals(GType.INT64)) {
                GVALUE_API.g_value_set_int64(this, validateVal(val, Long.class));
            } else if (g_type.equals(GType.UINT64)) {
                GVALUE_API.g_value_set_uint64(this, validateVal(val, Long.class));
            } else if (g_type.equals(GType.BOOLEAN)) {
                GVALUE_API.g_value_set_boolean(this, validateVal(val, Boolean.class));
            } else if (g_type.equals(GType.FLOAT)) {
                GVALUE_API.g_value_set_float(this, validateVal(val, Float.class));
            } else if (g_type.equals(GType.DOUBLE)) {
                GVALUE_API.g_value_set_double(this, validateVal(val, Double.class));
            } else if (g_type.equals(GType.STRING)) {
                GVALUE_API.g_value_set_string(this, validateVal(val, String.class));
            } else if (g_type.equals(GType.OBJECT)) {
                GVALUE_API.g_value_set_object(this, validateVal(val, GObject.class, true));
            } else if (g_type.equals(GType.POINTER)) {
                GVALUE_API.g_value_set_pointer(this, validateVal(val, Pointer.class));
            } else {
        ...
        public Integer toInt() {
            return g_type.equals(GType.INT) ? GVALUE_API.g_value_get_int(this) : null;
        }

        public Integer toUInt() {
            return g_type.equals(GType.UINT) ? GVALUE_API.g_value_get_uint(this) : null;
        }

        public Byte toChar() {
            return g_type.equals(GType.CHAR) ? GVALUE_API.g_value_get_char(this) : null;
        }

        public Byte toUChar() {
            return g_type.equals(GType.UCHAR) ? GVALUE_API.g_value_get_uchar(this) : null;
        }

        public Long toLong() {
            return g_type.equals(GType.LONG) ? GVALUE_API.g_value_get_long(this).longValue() : null;
        }

        public Long toULong() {
            return g_type.equals(GType.ULONG) ? GVALUE_API.g_value_get_ulong(this).longValue() : null;
        }

        public Long toInt64() {
            return g_type.equals(GType.INT64) ? GVALUE_API.g_value_get_int64(this) : null;
        }

        public Long toUInt64() {
            return g_type.equals(GType.UINT64) ? GVALUE_API.g_value_get_uint64(this) : null;
        }

        public Boolean toBoolean() {
            return g_type.equals(GType.BOOLEAN) ? GVALUE_API.g_value_get_boolean(this) : null;
        }

        public Float toFloat() {
            return g_type.equals(GType.FLOAT) ? GVALUE_API.g_value_get_float(this) : null;
        }

        public Double toDouble() {
            return g_type.equals(GType.DOUBLE) ? GVALUE_API.g_value_get_double(this) : null;
        }
    ...
    final class GValueArray extends com.sun.jna.Structure {
