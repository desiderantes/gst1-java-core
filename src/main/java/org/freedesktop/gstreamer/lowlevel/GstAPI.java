...
public interface GstAPI extends Library {
    ...
    interface GstCallback extends com.sun.jna.Callback {
        com.sun.jna.TypeMapper TYPE_MAPPER = new GTypeMapper();
    }
     ...
     * @see <a href="https://cgit.freedesktop.org/gstreamer/gstreamer/tree/gst/gstsegment.h?h=1.8"></a>
     * <p>
     * GstSegment:
     */
    final class GstSegmentStruct extends com.sun.jna.Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("flags", "rate", "applied_rate",
                    "format", "base", "offset",
                    "start", "stop", "time",
    ...
    final class GErrorStruct extends com.sun.jna.Structure {
