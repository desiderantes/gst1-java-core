...
public interface GObjectAPI extends Library {
    GObjectAPI GOBJECT_API = GNative.loadLibrary("gobject-2.0", GObjectAPI.class,
            Map.of(
                Library.OPTION_TYPE_MAPPER, new GTypeMapper(),
...
//    void g_signal_handler_disconnect(GObject obj, NativeLong id);
    ...
    interface GBaseInitFunc extends Callback {
        void callback(Pointer g_class);
    }

    interface GBaseFinalizeFunc extends Callback {
        void callback(Pointer g_class);
    }


    interface GClassInitFunc extends Callback {
        void callback(Pointer g_class, Pointer class_data);
    }

    interface GClassFinalizeFunc extends Callback {
        void callback(Pointer g_class, Pointer class_data);
    }

    interface GInstanceInitFunc extends Callback {
     ...
     */
    class GTypeClass extends com.sun.jna.Structure {
    ...
    final class GTypeClassByReference extends GTypeClass implements ByReference {
        //
    }

    final class GTypeInstance extends com.sun.jna.Structure {
    ...
    final class GObjectStruct extends com.sun.jna.Structure {
    ...
    final class GObjectConstructParam {
        public volatile Pointer spec;
        public volatile Pointer value;
    }

    final class GObjectClass extends com.sun.jna.Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("g_type_class", "construct_properties", "constructor",
        ...
        public interface Constructor extends Callback {
            Pointer callback(GType type, int n_construct_properties,
                                    GObjectConstructParam properties);
        }

        public interface SetProperty extends Callback {
            void callback(GObject object, int property_id, Pointer value, Pointer spec);
        }
        ...
        public interface Notify extends Callback {
            void callback(GObject object, Pointer spec);
        }

    }

    final class GTypeInfo extends com.sun.jna.Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("class_size", "base_init", "base_finalize",
    ...
    abstract class GParamSpecTypeSpecific extends com.sun.jna.Structure {
    ...
    final class GParamSpecBoolean extends GParamSpecTypeSpecific {
    ...
    final class GParamSpecInt extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("parent_instance", "minimum", "maximum",
                    "default_value");
        }

    }

    final class GParamSpecUInt extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
        public volatile int minimum;
        public volatile int maximum;
        public volatile int default_value;
        ...
        public Object getMinimum() {
            return ((long) minimum) & 0xffffff;
        }

        public Object getMaximum() {
            return ((long) maximum) & 0xffffff;
        }

        public Object getDefault() {
            return ((long) default_value) & 0xffffff;
        }
    ...
    final class GParamSpecChar extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
    ...
    final class GParamSpecUChar extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
        public volatile byte minimum;
        public volatile byte maximum;
        public volatile byte default_value;
        ...
        public Object getMinimum() {
            return ((short) minimum) & 0xff;
        }

        public Object getMaximum() {
            return ((short) maximum) & 0xff;
        }

        public Object getDefault() {
            return ((short) default_value) & 0xff;
        }
    ...
    final class GParamSpecLong extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
    ...
    final class GParamSpecInt64 extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
    ...
    final class GParamSpecFloat extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
    ...
    final class GParamSpecDouble extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
    ...
    final class GParamSpecString extends GParamSpecTypeSpecific {
        public volatile GParamSpec parent_instance;
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("parent_instance", "default_value", "cset_first",
                    "cset_nth", "substitutor", "null_fold_if_empty_ensure_non_null");
        }
    }

    final class GParamSpec extends com.sun.jna.Structure {
        public volatile GTypeInstance g_type_instance;
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("g_type_instance", "g_name", "g_flags",
