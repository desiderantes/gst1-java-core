...
public interface GstTagListAPI extends com.sun.jna.Library {
    ...
    @CallerOwnsReturn
    Pointer ptr_gst_tag_list_new_empty();
    ...
    @CallerOwnsReturn
    Pointer ptr_gst_tag_list_copy(TagList list);
    ...
    @CallerOwnsReturn
    Pointer ptr_gst_tag_list_merge(TagList list1, TagList list2, TagMergeMode mode);
