 ...
 *
 * @see <a href="https://github.com/GStreamer/gst-plugins-base/blob/master/gst-libs/gst/sdp/gstsdpmessage.h"></a>
 */
public interface GstSDPMessageAPI extends com.sun.jna.Library {
    ...
    final class SDPMessageStruct extends com.sun.jna.Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("version", "origin", "session_name", "information", "uri",
                    "emails", "phones", "connection", "bandwidths", "times",
                    "zones", "key", "attributes", "medias");
        }
    }

    final class SDPOriginStruct extends com.sun.jna.Structure {
    ...
    final class SDPKeyStruct extends com.sun.jna.Structure {
    ...
    final class SDPConnectionStruct extends com.sun.jna.Structure {
        public volatile String nettype;
        public volatile String addrtype;
