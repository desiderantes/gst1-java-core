...
public final class GstNative {
    ...
    private static final Map<String, Object> options = Map.ofEntries(
        Map.entry(Library.OPTION_TYPE_MAPPER, new GTypeMapper()),
        Map.entry(Library.OPTION_FUNCTION_MAPPER, new GFunctionMapper()),
        Map.entry(Library.OPTION_STRING_ENCODING, StandardCharsets.UTF_8.name())
    );
