 ...
 *
 * @see <a href="https://github.com/GStreamer/gstreamer/blob/master/gst/gstpromise.h"></a>
...
public interface GstPromiseAPI extends com.sun.jna.Library {
    ...
    @CallerOwnsReturn
    Promise gst_promise_new_with_change_func(GstCallback callback, Pointer userData, Pointer destroyNotify);

    @CallerOwnsReturn
    Pointer ptr_gst_promise_new_with_change_func(GstCallback callback, Pointer userData, Pointer destroyNotify);
    ...
    final class PromiseStruct extends com.sun.jna.Structure {
