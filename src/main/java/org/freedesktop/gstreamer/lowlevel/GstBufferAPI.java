 ...
 *
 * @see <a href="https://cgit.freedesktop.org/gstreamer/gstreamer/tree/gst/gstbuffer.h?h=1.8"></a>
 */
public interface GstBufferAPI extends com.sun.jna.Library {

    GstBufferAPI GSTBUFFER_API = GstNative.load(GstBufferAPI.class);

    int GST_LOCK_FLAG_READ = (1 << 0);
    int GST_LOCK_FLAG_WRITE = (1 << 1);
    int GST_MAP_READ = GST_LOCK_FLAG_READ;
    int GST_MAP_WRITE = GST_LOCK_FLAG_WRITE;
    ...
    @CallerOwnsReturn
    Buffer gst_buffer_new_allocate(Pointer allocator, int size, Pointer params);

    @CallerOwnsReturn
    Pointer ptr_gst_buffer_new();

    @CallerOwnsReturn
    Pointer ptr_gst_buffer_new_allocate(Pointer allocator, int size, Pointer params);
     ...
     * @see <a href="https://cgit.freedesktop.org/gstreamer/gstreamer/tree/gst/gstmemory.h?h=1.8"></a>
     * <p>
     * GstMapInfo:
     */
    final class MapInfoStruct extends com.sun.jna.Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("memory", "flags", "data", "size", "maxSize",
...
//    @CallerOwnsReturn Buffer gst_buffer_join(@Invalidate Buffer buf1, @Invalidate Buffer buf2);
     ...
     * variables.
     */
    final class BufferStruct extends com.sun.jna.Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("mini_object", "pool", "pts",
                    "dts", "duration",
                    "offset", "offset_end");
        }
