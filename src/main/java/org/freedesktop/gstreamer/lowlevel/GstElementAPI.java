 ...
 *
 * @see <a href="https://cgit.freedesktop.org/gstreamer/gstreamer/tree/gst/gstelement.h?h=1.8"></a>
 */
...
public interface GstElementAPI extends com.sun.jna.Library {
     ...
     * pads_cookie: updated whenever a pad is added or removed
     * <p>
     * GStreamer element abstract base class.
     */
    final class GstElementStruct extends com.sun.jna.Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("object", "state_lock", "state_cond",
     ...
     * functionality.
     */
    final class GstElementClass extends com.sun.jna.Structure {
        //
        // Actual data members
        //
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("parent_class", "metadata", "elementfactory",
        ...
        //
        public interface PadAdded extends GstCallback {
            void callback(Element element, Pad pad);
        }

        public interface PadRemoved extends GstCallback {
            void callback(Element element, Pad pad);
        }
        public interface NoMorePads extends GstCallback {
            void callback(Element element);
        }
        public interface RequestNewPad extends GstCallback {
            Pad callback(Element element, /* PadTemplate */ Pointer templ,
                                String name, Caps caps);
        }
        public interface ReleasePad extends GstCallback {
            void callback(Element element, Pad pad);
        }

        public interface GetState extends GstCallback {
            StateChangeReturn callback(Element element, Pointer /* GstState */ state,
                                              Pointer /* GstState */ pending, long timeout);
        }

        public interface SetState extends GstCallback {
            StateChangeReturn callback(Element element, State state);
        }
        public interface ChangeState extends GstCallback {
            StateChangeReturn callback(Element element, int transition);
        }

        public interface StateChanged extends GstCallback {
            StateChangeReturn callback(Element element, State oldState, State newState, State pending);
        }
        public interface SetBus extends GstCallback {
            void callback(Element element, Bus bus);
        }
        public interface ProvideClock extends GstCallback {
            void callback(Element element);
        }

        public interface SetClock extends GstCallback {
            void callback(Element element, Clock clock);
        }

        public interface SendEvent extends GstCallback {
            boolean callback(Element element, Event event);
        }

        public interface QueryNotify extends GstCallback {
            boolean callback(Element element, Query query);
        }

        public interface PostMessage extends GstCallback {
