...
public interface GlibAPI extends Library {
    ...
    int GLIB_SYSDEF_AF_UNIX = 1;
    int GLIB_SYSDEF_AF_INET = 2;
    int GLIB_SYSDEF_AF_INET6 = 23;
    ...
    final class GList extends com.sun.jna.Structure {
    ...
    final class GSList extends com.sun.jna.Structure {
        public volatile Pointer data;
        public volatile Pointer _next;
