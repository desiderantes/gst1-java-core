...
public class Clock extends GstObject {
    ...
    public static final class Calibration {
        ...
        public int hashCode() {
            int hash = 7;
            hash = 59 * hash + Long.hashCode(this.internal);
            hash = 59 * hash + Long.hashCode(this.external);
            hash = 59 * hash + Long.hashCode(this.rateNum);
            hash = 59 * hash + Long.hashCode(this.rateDenom);
            return hash;
        }
