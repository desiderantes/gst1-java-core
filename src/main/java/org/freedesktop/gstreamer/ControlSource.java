...
public class ControlSource extends GstObject {
     ...
     */
    public record TimedValue(long timestamp, double value) {
        ...
        public int hashCode() {
            int hash = 7;
            hash = 37 * hash + Long.hashCode(this.timestamp);
            hash = 37 * hash + Long.hashCode(Double.doubleToLongBits(this.value));
            return hash;
        }
