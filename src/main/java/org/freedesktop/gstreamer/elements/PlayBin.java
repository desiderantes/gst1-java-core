...
public class PlayBin extends Pipeline {
     ...
     * <p>
     * To disable audio output, call this method with a <pre>null</pre> argument.
     *
     ...
     * <p>
     * To disable video output, call this method with a <pre>null</pre> argument.
     *
     ...
     * <p>
     * To disable text output, call this method with a <pre>null</pre> argument.
     *
