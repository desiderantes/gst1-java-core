...
public class DecodeBin extends Bin {
    ...
    public interface AUTOPLUG_CONTINUE {
         ...
         * {@link Element}).
         */
        boolean autoplugContinue(DecodeBin element, Pad pad, Caps caps);
    }
    ...
    public interface AUTOPLUG_FACTORIES {
         ...
         * @return
         */
        Optional<List<ElementFactory>> autoplugFactories(DecodeBin element, Pad pad, Caps caps);
    }
    ...
    public interface AUTOPLUG_SELECT {
         ...
         */
        AutoplugSelectResult autoplugSelect(final DecodeBin element, final Pad pad, final Caps caps, final ElementFactory factory);
    }
    ...
    public interface AUTOPLUG_QUERY {
         ...
         */
        boolean autoplugQuery(DecodeBin element, Pad pad, Element child, Query query);
    }
    ...
    public interface DRAINED {
         ...
         */
        void drained(DecodeBin element);
    }
}
