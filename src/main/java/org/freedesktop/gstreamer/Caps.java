...
//        this.ref(); // gst_caps_simplify copies "this" and drops one reference
     ...
     *
     * <strong>note: This function does not work reliably if optional properties for caps are included on one caps and omitted on the other.</strong>
     *
