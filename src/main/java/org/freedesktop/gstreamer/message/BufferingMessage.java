 ...
 * <p>
 * When <pre>percent</pre> is &lt; 100 the application should PAUSE a PLAYING pipeline. When
 * <pre>percent</pre> is 100, the application can set the pipeline (back) to PLAYING.
 * The application must be prepared to receive BUFFERING messages in the
 * PREROLLING state and may only set the pipeline to PLAYING after receiving a
 * message with <pre>percent</pre> set to 100, which can happen after the pipeline
