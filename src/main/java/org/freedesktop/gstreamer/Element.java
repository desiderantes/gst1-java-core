...
public class Element extends GstObject {
     ...
     * @param units   the units of the <pre>timeout</pre>.
     * @return The {@link State} the Element is currently in.
     */
     ...
     * @return the requested Pad if found, otherwise <pre>null</pre>. Release
     ...
     *
     * @param listener Listener to be called when the {@link Element} has
     ...
     * @return <pre>true</pre> if the message was posted, <pre>false</pre> if the
