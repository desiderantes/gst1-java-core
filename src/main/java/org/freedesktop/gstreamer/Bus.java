...
public class Bus extends GstObject {
     ...
     * @return <pre>true</pre> if the message could be posted, <pre>false</pre> if
     * the bus is flushing.
     */
    ...
    private record MessageProxy<T>(MessageType type, Class<T> listenerClass, Object listener, BusCallback callback) {
