 ...
 * browsers
 *
 * @see <a href="https://developer.mozilla.org/en-US/docs/Web/API/RTCPeerConnection"></a>
 * @see <a href="https://gitlab.freedesktop.org/gstreamer/gst-plugins-bad/blob/master/ext/webrtc/gstwebrtcbin.c"></a>
...
public class WebRTCBin extends Bin {
     ...
     * after {@link #createOffer} or {@link #createAnswer(CREATE_ANSWER)} is called.
     *
    ...
    public interface CREATE_OFFER {
        ...
        /**
         * @param offer a @WebRTCSessionDescription of the offer
         */
    ...
    public interface CREATE_ANSWER {
        ...
        /**
         * @param answer a @WebRTCSessionDescription of the answer
         */
