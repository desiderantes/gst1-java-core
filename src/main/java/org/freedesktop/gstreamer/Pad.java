 ...
 * element with gst_element_get_static_pad(), the pads can be link with {@link #link}.
 ...
 * capable of dealing with. Pads created from a pad template cannot set
...
public class Pad extends GstObject {
     ...
     *
     * <p>
     * If this pad is a source pad, <pre>event</pre> should be an upstream event.
     * If this pad is a sink pad, <pre>event</pre> should be a downstream event.
     * <p>
     ...
     * @return <pre>true</pre> if the event was handled.
     */
