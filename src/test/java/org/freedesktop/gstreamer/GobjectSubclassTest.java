...
//        GObjectAPI.gobj.g_type_init_with_debug_flags(1 << 0);
    ...
    public void registerNewGObjectClass() throws Exception {
        ...
        final GClassInitFunc classInit = (g_class, class_data) -> classInitCalled[0] = true;
        final GObjectAPI.GBaseInitFunc baseInit = g_class -> GSTPADTEMPLATE_API.gst_element_class_add_pad_template(g_class, template);
