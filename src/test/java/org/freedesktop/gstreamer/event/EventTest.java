...
public class EventTest {
    ...
    public void gst_event_new_eos() {
        ...
        assertInstanceOf(EOSEvent.class, eos, "gst_event_new_eos returned a non-EOS event");
    }
    ...
    public void gst_event_new_flush_start() {
        ...
        assertInstanceOf(FlushStartEvent.class, ev, "gst_event_new_flush_start returned a non-FLUSH_START event");
    }
    ...
    public void gst_event_new_flush_stop() {
        ...
        assertInstanceOf(FlushStopEvent.class, ev, "gst_event_new_flush_stop returned a non-FLUSH_STOP event");
    }
    ...
    public void gst_event_new_latency() {
        ...
        assertInstanceOf(LatencyEvent.class, ev, "gst_event_new_latency returned a non-LATENCY event");
    }
    ...
    public void gst_event_new_new_segment() {
        ...
        assertNotNull(ev, "gst_event_new_latency returned null");
        assertInstanceOf(SegmentEvent.class, ev, "gst_event_new_latency returned a non-NEWSEGMENT event");
    }
...
//        final ClockTime MAGIC = ClockTime.valueOf(0xdeadbeef, TimeUnit.NANOSECONDS);
    ...
    public void gst_event_new_tag() {
        ...
        assertInstanceOf(TagEvent.class, ev, "gst_event_new_tag returned a non-TAG event");
    }
    ...
    public void TagEvent_testGC() {
        ...
        WeakReference<Event> evRef = new WeakReference<>(ev);
        ev = null;
    ...
    public void gst_event_new_buffer_size() {
        ...
        assertInstanceOf(BufferSizeEvent.class, ev, "gst_event_new_buffer_size returned a non-BUFFERSIZE event");
    }
    ...
    public void gst_event_new_qos() {
        ...
        assertInstanceOf(QOSEvent.class, ev, "gst_event_new_qos returned a non-QOS event");
    }
    ...
    public void gst_event_new_seek() {
        ...
        assertInstanceOf(SeekEvent.class, ev, "gst_event_new_seek returned a non-SEEK event");
    }
    ...
    public void gst_event_new_caps() {
        ...
        assertInstanceOf(CapsEvent.class, ev, "gst_event_new_caps returned a non-CAPS event");
    }
    ...
    public void gst_event_new_reconfigure() {
        ...
        assertInstanceOf(ReconfigureEvent.class, ev, "gst_event_new_reconfigure returned a non-RECONFIGURE event");
    }
    ...
    public void gst_event_new_stream_start() {
        ...
        assertInstanceOf(StreamStartEvent.class, ev, "gst_event_new_stream_start returned a non-STREAM-START event");
    }
    ...
    public void gst_event_new_step() {
        ...
        assertInstanceOf(StepEvent.class, ev, "gst_event_new_step returned a non-STEP event");
    }
}
