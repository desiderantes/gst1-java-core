...
public class StructureTest {
    ...
    public void testGetValue() {
        ...
        assertThrows(Structure.InvalidFieldException.class, () -> structure.getValue("noexist"));
    ...
    public void testGetValues() {
        ...
        assertThrows(Structure.InvalidFieldException.class, () -> structure.getValues(String.class, "valuearray"));
        assertThrows(Structure.InvalidFieldException.class, () -> structure.getValues(Double.class, "non_existent"));
    }
    ...
    public void testFraction() {
        ...
        assertEquals(10, structure.getFraction("fraction").numerator());
        assertEquals(1, structure.getFraction("fraction").denominator());

        structure.setFraction("fraction", 17, 10);
        assertEquals(17, structure.getFraction("fraction").numerator());
        assertEquals(10, structure.getFraction("fraction").denominator());
    }
    ...
    public void testSetNullObject() {
        ...
        assertFalse(structure.hasField("whatever"));
    }
    ...
    public void testIssue173() {
        ...
        assertInstanceOf(Structure.class, stats);
    }
}
