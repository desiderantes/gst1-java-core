...
public class PromiseTest {
    ...
    public void testReply() {
        ...
        assertEquals(PromiseResult.REPLIED, promiseStatus, "promise reply state not correct");
    }
    ...
    public void testInterrupt() {
        ...
        assertEquals(PromiseResult.INTERRUPTED, promiseStatus, "promise reply state not correct");
    }
    ...
    public void testExpire() {
        ...
        assertEquals(PromiseResult.EXPIRED, promiseStatus, "promise reply state not correct");
    }
    ...
    public void testReplyData() {
        ...
        promise.reply(data);
        assertEquals(PromiseResult.REPLIED, promise.waitResult(), "promise state not in replied");
    ...
    public void testChangeFunctionGC() {
        ...
        Promise promise = new Promise(promise1 -> onChangeFired.set(true));
        System.gc();
        System.gc();
        promise.interrupt();
