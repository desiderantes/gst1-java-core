...
public class QueryTest {
    ...
    public void gst_query_new_position() {
        ...
        assertInstanceOf(PositionQuery.class, query, "Returned query not instance of PositionQuery");
    }
    ...
    public void newDurationQuery() {
        ...
        assertInstanceOf(DurationQuery.class, query, "Returned query not instance of DurationQuery");
    }
    ...
    public void gst_query_new_latency() {
        ...
        assertInstanceOf(LatencyQuery.class, query, "Returned query not instance of LatencyQuery");
    }
...
//        ClockTime end = ClockTime.fromMillis(1000);
    ...
    public void formatsQuery() {
        ...
        assertNotNull(query, "gst_query_new_latency() returned null");
        assertInstanceOf(FormatsQuery.class, query, "Returned query not instance of LatencyQuery");
    }
...
//    }
    ...
    public void gst_query_new_allocation() {
        ...
        assertInstanceOf(AllocationQuery.class, query, "Returned query not instance of AllocationQuery");
    }
