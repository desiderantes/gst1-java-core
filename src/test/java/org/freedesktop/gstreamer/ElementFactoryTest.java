...
public class ElementFactoryTest {
    ...
    public void testMakeBin() {
        ...
        assertInstanceOf(Bin.class, e, "Element not a subclass of Bin");
    }
    ...
    public void testMakePipeline() {
        ...
        assertInstanceOf(Bin.class, e, "Element not a subclass of Bin");
        assertInstanceOf(Pipeline.class, e, "Element not a subclass of Pipeline");
    }
    ...
    public void testMakePlaybin() {
        ...
        assertInstanceOf(Bin.class, e, "Element not a subclass of Bin");
        assertInstanceOf(Pipeline.class, e, "Element not a subclass of Pipeline");
        assertInstanceOf(PlayBin.class, e, "Element not a subclass of PlayBin");
    }
    ...
    public void testMakeDecodeBin() {
        ...
        assertInstanceOf(Bin.class, e, "Element not a subclass of Bin");
        assertInstanceOf(DecodeBin.class, e, "Element not a subclass of DecodeBin");
    }
    ...
    public void testMakeURIDecodeBin() {
        ...
        assertInstanceOf(Bin.class, e, "Element not a subclass of Bin");
        assertInstanceOf(URIDecodeBin.class, e, "Element not a subclass of DecodeBin");
    }
    ...
    public void testGarbageCollection() throws Throwable {
        ElementFactory factory = ElementFactory.find("fakesrc");
        assertNotNull(factory, "Could not locate fakesrc factory");
        WeakReference<ElementFactory> ref = new WeakReference<>(factory);
        factory = null;
    ...
    public void testMakeGarbageCollection() throws Throwable {
        ...
        WeakReference<Element> ref = new WeakReference<>(e);
        e = null;
