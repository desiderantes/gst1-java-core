...
public class MessageTest {
    ...
    public void gst_message_new_eos() {
        ...
        assertInstanceOf(EOSMessage.class, msg, "gst_message_new_eos did not return an instance of EOSMessage");
    }
    ...
    public void postEOS() {
        ...
        pipe.getBus().connect("message::eos", (bus, msg) -> {
        ...
        assertInstanceOf(EOSMessage.class, msg, "Message not intance of EOSMessage");
    ...
    public void gst_message_new_percent() {
        ...
        assertInstanceOf(BufferingMessage.class, msg, "gst_message_new_eos did not return an instance of BufferingMessage");
    }
    ...
    public void postBufferingMessage() {
        ...
        final AtomicBoolean signalFired = new AtomicBoolean(false);
        final AtomicReference<Message> signalMessage = new AtomicReference<>(null);
        pipe.getBus().connect("message::buffering", (bus, msg) -> {
            signalFired.set(true);
            signalMessage.set(msg);
            pipe.quit();
        });
        ...
        assertInstanceOf(BufferingMessage.class, msg, "Message not instance of BufferingMessage");
    ...
    public void gst_message_new_duration() {
        ...
        assertInstanceOf(DurationChangedMessage.class, msg, "gst_message_new_duration did not return an instance of DurationMessage");
    }
    ...
    public void postDurationMessage() {
        ...
        final AtomicBoolean signalFired = new AtomicBoolean(false);
        final AtomicReference<Message> signalMessage = new AtomicReference<>(null);
        pipe.getBus().connect("message::duration-changed", (bus, msg) -> {
            signalFired.set(true);
            signalMessage.set(msg);
            pipe.quit();
        });
        ...
        assertInstanceOf(DurationChangedMessage.class, msg, "Message not instance of EOSMessage");
        assertEquals(pipe.src, msg.getSource(), "Wrong source in message");
        pipe.dispose();
    }
    ...
    public void gst_message_new_tag() {
        ...
        assertInstanceOf(TagMessage.class, msg, "gst_message_new_tag did not return an instance of TagMessage");
    }
    ...
    public void gst_message_new_state_changed() {
        ...
        assertInstanceOf(StateChangedMessage.class, msg, "gst_message_new_state_changed did not return an instance of StateChangedMessage");
    }
    ...
    public void postStateChangedMessage() {
        ...
        pipe.getBus().connect("message::state-changed", (bus, msg) -> {
            signalFired.set(true);
            signalMessage.set(msg);
            pipe.quit();
        });
    ...
    public void gst_message_new_segment_done() {
        ...
        assertInstanceOf(SegmentDoneMessage.class, msg, "gst_message_new_segment_done did not return an instance of SegmentDoneMessage");
    }
    ...
    public void postSegmentDoneMessage() {
        ...
        pipe.getBus().connect("message::segment-done", (bus, msg) -> {
            signalFired.set(true);
            signalMessage.set(msg);
            pipe.quit();
        });
    ...
    public void postLatencyMessage() {
        ...
        pipe.getBus().connect("message::latency", (bus, msg) -> {
            signalFired.set(true);
            signalMessage.set(msg);
            pipe.quit();
        });
